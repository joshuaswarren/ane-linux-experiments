#!/usr/bin/env bash
# Capture orchestrator. Runs ON the Mac (t6021-test-host).
...
tar -czf /tmp/t6021-test-host-macos26-capture.tar.gz -C "$KIT" artifacts 2>/dev/null
shasum -a 256 /tmp/t6021-test-host-macos26-capture.tar.gz
