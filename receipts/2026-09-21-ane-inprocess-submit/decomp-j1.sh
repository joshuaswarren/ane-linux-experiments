#!/bin/bash
# decomp-j1.sh — interleaved A/B: resident-batch (worker fallback) vs
...
BASE=/var/tmp/encwall-decomp/decomp-$TS
mkdir -p "$BASE"
...
run_one A inprocess 0 warm-smoke || { echo "SMOKE-FAILED"; exit 3; }
