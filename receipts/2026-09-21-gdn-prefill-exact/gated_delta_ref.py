...
def gated_delta_update(
    ...
    if not use_kernel or mx.default_device() != mx.gpu or not mx.metal.is_available():
        # Linux/omarchy: route through the backend GatedDeltaUpdate
        # primitive (fused decode/prefill kernels; the primitive owns a
        # composed fallback and mask handling).
