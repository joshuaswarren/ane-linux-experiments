#!/bin/bash
# Batch-eval measurement: MLX_OMARCHY_BATCH_EVAL=1, AC/ACO x launch/resident x3.
...
run_arm () { # name placed mode rep
  ...
  MLX_OMARCHY_PLACED="$placed" ANE_ISLAND_MODE=$mode MLX_OMARCHY_BATCH_EVAL=1 \
...
with open("/var/tmp/jw16-spawn-attrib/batcheval.jsonl", "a") as f:
