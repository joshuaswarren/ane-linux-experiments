#!/bin/bash
# v0.6.3 release gate on jw16 (M1 Max) — corrected driver.
...
WHLF=$ROOT/mlx_omarchy-0.32.2.dev202609171159+1ed1dab-cp314-cp314-linux_aarch64.whl
OUT=/var/tmp/v063-release-gate-jw16
STATUS=/var/tmp/v063-release-jw16.status
