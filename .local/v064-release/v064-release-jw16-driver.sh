#!/bin/bash
# v0.6.4 release gate on jw16 (M1 Max) — corrected driver.
...
WHLF=$ROOT/mlx_omarchy-0.32.2.dev202609171442+112c32c-cp314-cp314-linux_aarch64.whl
OUT=/var/tmp/v064-release-gate-jw16
STATUS=/var/tmp/v064-release-jw16.status
